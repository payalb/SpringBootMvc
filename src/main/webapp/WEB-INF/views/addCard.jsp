...
<title><spring:message code="addCard"></spring:message></title>
		...
		<div class="container">
			...
			<div class="row" >
	            <div class="col-md-12 order-md-1">
	                <h4 class="mb-3"><spring:message code="addCard"></spring:message></h4>
	                <form class="needs-validation" action="addCard">
	                    ...
	                    <div class="row">
	                        ...
	                        <div class="col-md-6 mb-3">
	                            ...
	                            <input type="number" class="form-control" id="cardNum" name="cardNum"
	                                   placeholder="<spring:message code="cardNum"></spring:message>" value="" required>
	                        </div>
	                    </div>
						<div class="row">
	                        <div class="col-md-6 mb-3">
	                            ...
	                            <input type="text" class="form-control" id="expiration" name="expiration"
	                                   placeholder="MM-yyyy" value="" required>
	                        </div>
	                        <div class="col-md-6 mb-3">
	                            <label for="cvv">CVV</label>
	                            <input type="number" class="form-control" id="cvv" name="cvv"
	                                   placeholder="CVV" value="" required>
	                        </div>
	                    </div>
	                    <hr class="mb-4">
