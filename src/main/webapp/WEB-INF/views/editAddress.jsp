...
<title><spring:message code="editAddress"></spring:message></title>
		...
		<div class="container">
			<nav class="mb-3">
				<ol class="breadcrumb">
					...
					<li class="breadcrumb-item active" aria-current="page">
						<spring:message code="editAddress"></spring:message>
					</li>
				</ol>
			</nav>
			...
			<div class="row" >
	            <div class="col-md-12 order-md-1">
	                ...
	                <form class="needs-validation" action="editAddress">
	                    <div class="row">
	                        ...
	                        <div class="col-md-12 mb-3">
	                            ...
	                            <input type="text" class="form-control" id="fullName" name="fullName"
	                                   ...
	                                   value="${address.getFullName()}" required>
	                        </div>
	                    </div>
	                    ...
	                    <div class="mb-3">
	                        ...
	                        <input type="text" class="form-control" id="street" name="street"
	                        	placeholder="<spring:message code="address"></spring:message>" 
	                        	value="${address.getStreet()}" required>
	                    </div>
	
	                    <div class="mb-3">
	                        <label for="streetTwo">
	                        	<spring:message code="address"></spring:message> 2 
	                        ...
	                        <input type="text" class="form-control" id="streetTwo" name="streetTwo"
	                        	placeholder="<spring:message code="apartment"></spring:message> 
	                        	<spring:message code="or"></spring:message> 
	                        	<spring:message code="suite"></spring:message>" value="${address.getStreetTwo()}">
	                    </div>
	                    ...
	                    <div class="row">
	                        <div class="col-md-3 mb-3">
	                            ...
	                            <input type="text" class="form-control" id="city" name="city"
	                            	placeholder="<spring:message code="city"></spring:message>" 
	                            	value="${address.getCity()}" required>
	                        </div>
	                        <div class="col-md-3 mb-3">
	                            <label for="state"><spring:message code="state"></spring:message></label>
	                            <input type="text" class="form-control" id="state" name="state" 
	                            	placeholder="<spring:message code="state"></spring:message>" 
	                            	value="${address.getState()}" required>
	                        </div>
	                        <div class="col-md-3 mb-3">
	                            <label for="zip">Zip</label>
	                            <input type="text" class="form-control" id="zip" name="zip" 
	                            	placeholder="Zip <spring:message code="code"></spring:message>" 
	                            	value="${address.getZip()}" required>
	                        </div>
	                        <div class="col-md-3 mb-3">
	                            <label for="country"><spring:message code="country"></spring:message></label>
	                            <input type="text" class="form-control" id="country" name="country" 
	                            	placeholder="<spring:message code="country"></spring:message>" 
